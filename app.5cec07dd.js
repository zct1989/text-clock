...
var spritejs_1 = require("spritejs");

window.onload = function () {
  var scene = new spritejs_1.Scene('#scene', {
    viewport: ['auto', 'auto'],
    resolution: [3080, 800]
  });
  var layer = scene.layer();
  var robot = new spritejs_1.Sprite('https://p5.ssl.qhimg.com/t01c33383c0e168c3c4.png');
  robot.attr({
    anchor: [0, 0.5],
    pos: [0, 0]
  });
...
},{"spritejs":"node_modules/spritejs/src/spritejs.esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
